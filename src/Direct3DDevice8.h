...
{
public:
	CDirect3DDevice8(IDirect3DDevice9* device, CDirect3D8* d3d);
...
public:
	...
	CObjectPool<CDirect3DSurface8>       SurfacePool;
	CObjectPool<CDirect3DSwapChain8>     SwapChainPool;
	CObjectPool<CDirect3DTexture8>       TexturePool;
	CObjectPool<CDirect3DVertexBuffer8>  VertexBufferPool;
	CObjectPool<CDirect3DVolumeTexture8> VolumeTexturePool;
	CObjectPool<CDirect3DVolume8>        VolumePool;
